...
<div>
  ...
  {/* Hero Section */}
  <div
    className="hero-container hero-container-normal hero-container-about"
  ...
  >
     ...
     {/* Text Section */}
      <h1 className="hero-title"> Rreth Nesh </h1>
        ...
        <section className="intro-section">
          <div className="intro-columns">
            <div className="intro-text">
              ...
              <a className="btn btn-secondary" href="../projekte-2/index.html">
                Projektet tona
              </a>
            </div>
        ...
        <section className="values-section">
          ...
          <div className="columns">
            ...
            <div className="column">
              ...
              />
              <p>
                Produktet tona janë inovative dhe efikase për të kompletuar ambientet tuaja. Bashkëpunimi jonë me partnerët e njohur ndërkombëtarë, si <strong>IVARS S.p.a.</strong>, <strong>OMSI S.r.l.</strong> dhe <strong>METALMECCANICA ALBA S.r.l.</strong>, na jep mundësinë të sjellim në treg produktet më inovative dhe të fundit në fushën e mobilimit. Ky gërshetim i përvojës sonë 25-vjeçare me patentime dhe ekspertizë ndërkombëtare siguron që ju të merrni produktet më të mira për nevojat tuaja.
              </p>
            </div>
            <div className="column">
